...
-- Set to true if you have a Nerd Font installed and selected in the terminal s
...
vim.keymap.set('n', 'è', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
-- Keep cursor in middle of screen when going to next search result
vim.keymap.set('n', 'n', 'nzzzv')
vim.keymap.set('n', 'N', 'Nzzzv')

-- In multile insert, allow control c to append the text written to all lines
...
vim.g.lsp_offset_encoding = 'utf-16'
